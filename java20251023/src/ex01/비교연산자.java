...
//		System.out.println(s3 == s4); X
		...
		String stage = (age>=20) ? "성년" : "미성년";
	    System.out.println("당신은 " + stage);
	     */
		...
		/*
		 * System.out.println("정수를 입력하세요>> "); int number = sc.nextInt();
		 * 
		 * String stage = (number % 2 == 0) ? "짝수" : "홀수"; System.out.println(number +
		 * "는"+ stage + "입니다.");
		 */
		
		/* 
		 * 정수 입력 받아서, 3을 나누어서 나머지 0,1,2 판별
		 */
